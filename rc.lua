...
beautiful.init(gears.filesystem.get_configuration_dir() .. "themes/sgm/theme.lua")
--beautiful.init(gears.filesystem.get_configuration_dir() .. "themes/holo/theme.lua")
...
local function set_wallpaper(s)
    ...
    gears.wallpaper.maximized("/home/stefan/.config/awesome/themes/sgm/wallpaper.jpg", s, true)
...
--              {description = "run prompt", group = "launcher"}),
    ...
    awful.key({ modkey },            "r",     function () 
               awful.util.spawn("rofi -modi drun -show drun -show-icons -width 22 -no-click-to-exit", false) end,
              {description = "run prompt", group = "launcher"}),
    ...
    awful.key({ modkey }, "Print", function() awful.util.spawn_with_shell("scrot --focused --exec 'mv $f ~/Pictures/Screenshots/'") end, 
...
awful.rules.rules = {
    ...
    { rule = { instance = "set_on_s1t1"},
      properties = { screen = 1, tag = "1" } },
    { rule = { instance = "set_on_s1t2"},
      properties = { screen = 1, tag = "2" } },
    { rule = { instance = "set_on_s1t3"},
      properties = { screen = 1, tag = "3" } },
    { rule = { instance = "set_on_s1t4"},
      properties = { screen = 1, tag = "4" } },
    { rule = { instance = "set_on_s1t5"},
      properties = { screen = 1, tag = "5" } },
    { rule = { instance = "set_on_s1t6"},
...
awful.spawn.with_shell("xrandr --output DP-2 --auto --pos 2560x0 --output DP-0 --auto --pos 0x0")


--awful.spawn.once(terminal, { tag = "8"; })
--awful.spawn("google-chrome", { tag = awful.tag.find_by_name(awful.screen.focused(), "1")})
--awful.spawn("glxgears", { tag = awful.tag.find_by_name(awful.screen.focused(), "2")})
--local tag = awful.tag.find_by_name(awful.screen.focused(), "2")
--naughty.notify({text=tag})
...
--run_once( "glxgears",nil,"glxgears")
